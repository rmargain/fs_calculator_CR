...
export default function CurrentStoreStatus({
    ...
    const rows = [
        createData('Unidades', averageUnitsOrder.toFixed(2), unidadesEnvioGratisPorOrden.toFixed(2), averageUnitsOrder.toFixed(2)),
        createData('Precio', currentProductPrice.toFixed(2), currentProductPrice.toFixed(2), currentProductPrice.toFixed(2)),
        createData('Venta de Producto', venta.toFixed(2), ventaEnvioGratis.toFixed(2), ventaEnvioPagado.toFixed(2)),
        createData('Envío', envio.toFixed(2), envioPagadoPorCliente.toFixed(2), envioPagadoPorCliente2.toFixed(2)),
        createData('Venta Total', ventaTotal.toFixed(2), ventaTotalEnvioGratis.toFixed(2), ventaTotalEnvioPagado.toFixed(2)),
        createData('Comisión CR', comisionCR.toFixed(2), comisionCREnvioGratis.toFixed(2), comisionCREnvioPagado.toFixed(2)),
        createData('Comisión Pagos', pagos.toFixed(2), pagosEnvioGratis.toFixed(2), pagosEnvioPagado.toFixed(2)),
        createData('Costo Envío Gratis', costoEnvioGratisActual.toFixed(2), costoEnvioGratis.toFixed(2), costoEnvioGratis2.toFixed(2)),
        createData('IVA', ivaActual.toFixed(2), ivaEnvioGratis.toFixed(2), ivaEnvioPagado.toFixed(2)),
        createData('ISR', isrActual.toFixed(2), isrEnvioGratis.toFixed(2), isrEnvioPagado.toFixed(2)),
        createData('Percepción por Venta', percepcionActual.toFixed(2), percepcionEnvioGratis.toFixed(2), percepcionEnvioPagado.toFixed(2)),
        createData('Costo del Producto', costoTotalActual.toFixed(2), costoTotalEnvioGratis.toFixed(2), costoTotalEnvioPagado.toFixed(2)),
        createData('Ganancia Neta', gananciaNetaActual.toFixed(2), gananciaNetaEnvioGratis.toFixed(2), gananciaNetaEnvioPagado.toFixed(2)),
        createData('Ganancia Neta por Unidad', gananciaNetaPorUnidadActual.toFixed(2), gananciaNetaPorUnidadEnvioGratis.toFixed(2), gananciaNetaPorUnidadEnvioPagado.toFixed(2)),
        createData('Ganancia Neta Ponderada', "", "", gananciaNetaPromedioPonderadoPorUnidad.toFixed(2))
    ]
        ...
        return(
            ...
            <Card variant="outlined">
              <Paper elevation={3} style={{display: 'flex', flexDirection:'column', alignItems: 'center'}}>
                ...
                <h3>Precio del Producto: {Math.round(currentProductPrice*100)/100}</h3>
              </Paper>
            </Card>
