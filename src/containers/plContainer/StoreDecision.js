...
export default function StoreDecision({
  ...
  return (
    <div>
      ...
      <div>
        <h2>
          Con base en las variables e historial de ventas que ingresaste no
          podemos darte una recomendación.
        </h2>
        <h3>
          {" "}
        ...
        <ul>
          ...
          <li>
            El número de unidades mensuales actuales combinado con el precio del
            producto no es suficiente para cubrir el mínimo de $499 para envíos
            gratis en el futuro.
          </li>
        </ul>
        <h3>
          ¿Cómo lo resuelvo? - PENSEMOS EN GRANDE Y MODELEMOS UN CASO TEÓRICO
        </h3>
        <ul>
          <li>
          ...
          <li>
            Ajusta Unidades por orden promedio: Ingresa el número de unidades
            equivalente a $300 (aproximadamente).
          </li>
          <li>
            Ajusta Unidades promedio vendidas al mes: Ingresa 100 unidades
            (recuerda: es un caso teórico y simularemos cómo se ven esas mismas
            100 unidades ofreciendo o no envíos gratis).
          </li>
        </ul>
      </div>
      :
        ...
        <Card variant="outlined" className="input-container">
          ...
          <Card variant="outlined">
            ...
            >
              ...
              <Typography className="data-point">
                {Math.round((price / currentProductPrice - 1) * 100).toFixed(0)}
                %
              </Typography>
            </Paper>
          </Card>
